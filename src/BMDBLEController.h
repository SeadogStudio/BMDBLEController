...
#define CHARACTERISTIC_UUID_CAMERA_STATUS "f88737b8-6d75-11e6-8b77-86f30ca893d3"
#define CHARACTERISTIC_UUID_DEVICE_NAME  "2a00" // Add Device Name Characteristic
