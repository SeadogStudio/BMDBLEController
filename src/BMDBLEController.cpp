...
// We need to define these callback classes in the implementation file
// and make sure they inherit from the BLE library's base classes

// Advertised device callbacks class implementation
...
// Security callbacks class implementation
